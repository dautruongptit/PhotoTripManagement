...
export default function LoginPage({ theme, onToggleTheme }: Props) {
    ...
    <div className="min-h-screen flex relative">
      ...
      <div className="hidden lg:flex lg:w-3/5 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-14 w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-semibold text-lg tracking-tight">Travel Photo</span>
          </div>
          {/* Quote */}
          <div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 bg-white dark:bg-gray-900">
        ...
        <div className="lg:hidden flex items-center gap-3 mb-12">
          ...
          <span className="text-gray-900 dark:text-white font-semibold text-xl tracking-tight">Travel Photo</span>
        </div>
        ...
        <div className="w-full max-w-sm slide-up">
          ...
          {/* Đăng nhập bằng Google: redirect toàn trang sang backend, KHÔNG phải popup */}
          <button
            onClick={handleGoogleLogin}
            disabled={redirecting}
            className="w-full flex items-center justify-center gap-3 h-[52px] rounded-2xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-200 text-sm font-semibold hover:border-blue-400 hover:shadow-md transition-all disabled:opacity-60"
          >
            {redirecting ? (
            ...
            {redirecting ? 'Đang chuyển đến Google…' : 'Tiếp tục với Google'}
          </button>
